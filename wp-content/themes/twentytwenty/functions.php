...
function twentytwenty_menu_scripts()
{

	$theme_version = wp_get_theme()->get('Version');


	wp_enqueue_script('twentytwenty-scriptjs', get_template_directory_uri() . '/assets/js/script.js', array(), $theme_version, false);
	wp_script_add_data('twentytwenty-scriptjs', 'async', true);
}

add_action('wp_enqueue_scripts', 'twentytwenty_menu_scripts');

add_action('wp_enqueue_scripts', function () {
	wp_add_inline_script('twentytwenty-scriptjs', 'var $ = jQuery.noConflict();');
});
