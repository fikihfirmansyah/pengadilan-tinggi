...
/**
 * A template partial to output pagination for the Pengadilan Tinggi default theme.
 *
...
$prev_text = sprintf(
	'%s <span>%s</span>',
	'<span class="csbutton normal" aria-hidden="true">&larr; Newer Post</span>',
	/*
...
$next_text = sprintf(
	'%s <span>%s</span>',
	'<span class="csbutton normal" aria-hidden="true">Older Post &rarr;</span>',
	/*
	 * Translators: This text contains HTML to allow the text to be shorter on small screens.
	 * The text inside the span with the class nav-short will be hidden on small screens.
	 */
