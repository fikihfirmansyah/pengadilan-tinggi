...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	$image_url = !post_password_required() ? get_the_post_thumbnail_url(get_the_ID(), 'pengadilantinggi-fullscreen') : '';
			...
			<div class="cover-header-inner">
				...
				<header class="entry-header has-text-align-center">
					<div class="entry-header-inner section-inner medium">
						 ...
						 */
						$show_categories = apply_filters('pengadilantinggi_show_categories_in_entry_header', true);
						...
						?>
							...
							<div class="to-the-content-wrapper">
								...
								<a href="#post-inner" class="to-the-content fill-children-current-color">
									<?php pengadilantinggi_the_theme_svg('arrow-down'); ?>
									<div class="screen-reader-text"><?php _e('Scroll Down', 'pengadilantinggi'); ?></div>
								</a><!-- .to-the-content -->
						...
						<?php
							...
							pengadilantinggi_the_post_meta(get_the_ID(), 'single-top');
						}
						?>
	...
	<div class="post-inner" id="post-inner">
		...
		wp_link_pages(
			array(
				'before'      => '<nav class="post-nav-links bg-light-background" aria-label="' . esc_attr__('Page', 'pengadilantinggi') . '"><span class="label">' . __('Pages:', 'pengadilantinggi') . '</span>',
				'after'       => '</nav>',
		...
		pengadilantinggi_the_post_meta(get_the_ID(), 'single-bottom');
