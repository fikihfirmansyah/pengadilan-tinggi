 ...
 * @return {Object} - this
 */
function _pengadilanTinggiColor(backgroundColor, accentHue) {
 ...
 * @return {Object} - this
 */
_pengadilanTinggiColor.prototype.setAccentColorsArray = function () {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_pengadilanTinggiColor.prototype.getTextColor = function () {
 ...
 * @return {Color} - Returns a Color object.
 */
_pengadilanTinggiColor.prototype.getAccentColor = function () {
	var fallback;
...
/**
 * Return a new instance of the _pengadilanTinggiColor object.
 *
 * @since Pengadilan Tinggi 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function pengadilanTinggiColor(backgroundColor, accentHue) { // jshint ignore:line
	var color = new _pengadilanTinggiColor(backgroundColor, accentHue);
